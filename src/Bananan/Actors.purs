...
import Engine.Model (class Actor)

newtype TestBall = TestBall {testBall :: Int}

instance actorTestBall :: Actor TestBall where
  getActorNameId tb = "testBall"
  getActorX tb = 100.0
  getActorY tb = 200.0
  getActorZ tb = 17
  getActorVisible tb = true
  getActorAngle tb = 0.0
  getActorHhtmlElement tb = Nothing
  mkActorsFromConfig conf = pure []

instance showTestBall :: Show TestBall where
  show (TestBall tb) = "TestBall " <> show tb.testBall
